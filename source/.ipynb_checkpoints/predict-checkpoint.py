...
def input_fn(serialized_input_data, content_type):
    ...
    # raise Exception('okay, we reached input_fn and the datatype is {}'.format(content_type))
...
def predict_fn(input_data, model):
    ...
    img_multiple_of = 8
    data = TF.to_tensor(input_data).unsqueeze(0).cuda()
    '''
    if use_cuda:
    ...
    data = F.pad(input_data, (0,padw,0,padh), 'reflect')
